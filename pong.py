...
# / canvas_height or canvas_width - because without this the prediction values are too big
    ...
    def train(self):
        ...
        xs += tf.random.normal(xs.shape) / 5    # add gaussien noise because the data is perfect otherwise - risk of overfitting
...
# it was necessary to distinguish between 1) save data, 2) train the model, 3) predict moves
    if frame_counter < 2000: #216000:
        # Save game data for the first N frames
        ...
        ai.save_data(player1_y, computer_y, ball_x, ball_y) # update coordinates after training
